...
* ```date_query``` (*array*)
    ...
    ```column``` is used to query specific column from ```wp_posts``` table. This will return posts which are created after
    January 1st 2012 and January 3rd 2012 8AM GMT:
