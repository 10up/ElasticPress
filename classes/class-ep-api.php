...
class EP_API {
	...
	public function query( $index, $type, $args, $query_args ) {
		...
		$request = ep_remote_request( $path, $request_args, $query_args, 'query' );
	...
	public function delete_document( $index, $type, $document_id, $blocking = true  ) {
		...
		$request = ep_remote_request( $path, $request_args, array(), 'delete' );
	...
	public function get_document( $index, $type, $document_id ) {
		...
		$request = ep_remote_request( $path, $request_args, array(), 'get' );
	...
	public function delete_network_alias( $alias ) {
		...
		$request = ep_remote_request( $path, $request_args, array(), 'delete_network_alias' );
	...
	public function bulk_index( $index, $type, $body ) {
		...
		$request = ep_remote_request( $path, $request_args, array(), 'bulk_index' );
