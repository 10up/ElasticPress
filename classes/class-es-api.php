...
function es_post_indexed( $post_id, $site_id = null, $host_site_id = null ) {
	...
	return $es_api->post_indexed( $post_id, $site_id, $host_site_id );
}

function es_delete_post( $post_id, $site_id = null, $host_site_id = null ) {
	global $es_api;

	return $es_api->delete_post( $post_id, $site_id, $host_site_id );
}