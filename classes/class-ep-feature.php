...
class EP_Feature {
	...
	/**
	 * Returns dependencies check status.
	 *
	 * @since  2.2
	 *
	...
	public function dependencies_met() {
		...
		if ( ! empty( $this->dependencies_met_cb ) ) {
			$dependencies_check = call_user_func( $this->dependencies_met_cb, $this );
		}

		return apply_filters( 'ep_feature_dependencies_met', $dependencies_check, $this );
	}
