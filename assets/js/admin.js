...
const handleWeightFields = () => {
	const checkboxes = document.querySelectorAll( '.weighting-settings .searchable input[type=checkbox]' );
	...
	const handleCheckboxChange = event => {
		...
		const rangeInput = checkbox.parentNode.nextElementSibling.querySelector( 'input[type=range]' );
