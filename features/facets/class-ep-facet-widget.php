...
class EP_Facet_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$located = untrailingslashit( EP_PATH . '/includes/facet-frontend-template.php' );
		// Allow developers to customize facet widget
		$located = apply_filters( 'ep_widget_get_template', $located );
