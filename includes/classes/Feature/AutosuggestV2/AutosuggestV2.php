...
class AutosuggestV2 extends Feature {
	...
	public function __construct() {
		...
		$this->requires_feature = 'instant-results';
	...
	public function get_args_schema() {
		 ...
		 */
		$per_page = apply_filters( 'ep_instant_results_per_page', $this->settings['per_page'] ?? '3' );
	 ...
	 */
	public function intercept_search_request( $response, $query = array() ) {
