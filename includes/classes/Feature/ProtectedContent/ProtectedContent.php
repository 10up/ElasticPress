...
class ProtectedContent extends Feature {
	...
	public function __construct() {
		...
		$this->summary = '<p>' . __( 'Securely indexes unpublished content — including private, draft, and scheduled posts — improving load times in places like the administrative dashboard where WordPress needs to include protected content in a query.', 'elasticpress' ) . '</p>' .
