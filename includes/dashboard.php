...
function action_admin_enqueue_dashboard_scripts() {
	...
	if ( in_array( Screen::factory()->get_current_screen(), [ 'dashboard', 'settings', 'install', 'health', 'weighting', 'synonyms', 'sync', 'status-report', 'elasticpress-io' ], true ) ) {
		wp_enqueue_style(
			'ep_admin_styles',
...
function action_admin_menu() {
	...
	add_submenu_page(
		'elasticpress',
		esc_html__( 'ElasticPress.io', 'elasticpress' ),
		esc_html__( 'ElasticPress.io', 'elasticpress' ),
		$capability,
		'elasticpress-io',
		__NAMESPACE__ . '\resolve_screen'
