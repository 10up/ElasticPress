...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_25___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_25__);
...
/* harmony import */ var _utils_helpers__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./utils/helpers */ "./assets/js/utils/helpers.js");
/* harmony import */ var element_closest__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! element-closest */ "./node_modules/element-closest/index.mjs");
/* harmony import */ var promise_polyfill_src_polyfill__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! promise-polyfill/src/polyfill */ "./node_modules/promise-polyfill/src/polyfill.js");
/* harmony import */ var whatwg_fetch__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! whatwg-fetch */ "./node_modules/whatwg-fetch/fetch.js");
...
function buildSearchQuery(searchText, placeholder, _ref) {
  ...
  var newQuery = Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_28__["replaceGlobally"])(query, placeholder, searchText);
  return newQuery;
}
/**
...
function _esSearch() {
  _esSearch = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_27___default()(
  /*#__PURE__*/
  _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_25___default.a.mark(function _callee2(query, searchTerm) {
    var fetchConfig, response, data;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_25___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if ((epas === null || epas === void 0 ? void 0 : epas.http_headers) && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_23___default()(epas.http_headers) === 'object') {
              Object.keys(epas.http_headers).forEach(function (name) {
...
function updateAutosuggestBox(options, input) {
  ...
  var container = Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_28__["findAncestorByClass"])(input, 'ep-autosuggest-container');
  ...
  for (i = 0; resultsLimit > i; ++i) {
    var text = options[i]._source.post_title;
    var url = options[i]._source.permalink;
    var escapedText = Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_28__["escapeDoubleQuotes"])(text);
    var searchParts = value.trim().split(' ');
    var resultsText = escapedText;

    if (epas.highlightingEnabled) {
      // uses some regex magic to match upper/lower/capital case
      var regex = new RegExp("\\b(".concat(searchParts.join('|'), ")"), 'gi');
      resultsText = resultsText.replace(regex, function (word) {
        return "<".concat(epas.highlightingTag, " class=\"").concat(epas.highlightingClass, " ep-autosuggest-highlight\">").concat(word, "</").concat(epas.highlightingTag, ">");
      });
    }

    var itemHTML = "<li class=\"autosuggest-item\" role=\"option\" aria-selected=\"false\" id=\"autosuggest-option-".concat(i, "\">\n\t\t\t\t<a href=\"").concat(url, "\" class=\"autosuggest-link\" data-search=\"").concat(escapedText, "\" data-url=\"").concat(url, "\"  tabindex=\"-1\">\n\t\t\t\t\t").concat(resultsText, "\n\t\t\t\t</a>\n\t\t\t</li>");
  ...
  suggestList.addEventListener('click', function (event) {
    var _epas$highlightingTag;

    event.preventDefault();
    var target = event.target.tagName === ((_epas$highlightingTag = epas.highlightingTag) === null || _epas$highlightingTag === void 0 ? void 0 : _epas$highlightingTag.toUpperCase()) ? event.target.parentElement : event.target;
...
function init() {
  var selectors = [epas.defaultSelectors, epas.selector].filter(Boolean).join(',');

  if (!selectors) {
    return;
  }

  var epInputNodes = document.querySelectorAll(selectors); // build the container into which we place the search results.
  ...
  var epInputs = Array.from(epInputNodes).filter(function (node) {
    return !node.classList.contains('facet-search') && !node.classList.contains('wp-block-search__input');
  }); // Handle search blocks separately

  var epBlockInputs = Array.from(epInputNodes).filter(function (node) {
    return node.classList.contains('wp-block-search__input');
  });
  ...
  epBlockInputs.forEach(function (input) {
    // Disable autocomplete
    input.setAttribute('autocomplete', 'off');
    input.closest('form').classList.add('ep-autosuggest-container');
    var clonedContainer = epAutosuggest.cloneNode(true);
    input.parentElement.insertAdjacentElement('afterend', clonedContainer); // announce that this is has been done
  ...
  /*#__PURE__*/
  function () {
    var _ref2 = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_27___default()(
    /*#__PURE__*/
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_25___default.a.mark(function _callee(input) {
      var searchText, placeholder, queryJSON, query, response, hits;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_25___default.a.wrap(function _callee$(_context) {
        while (1) {
  ...
  var handleKeyup = function handleKeyup(event) {
    ...
    var input = event.target;
    var debounceFetchResults = Object(_utils_helpers__WEBPACK_IMPORTED_MODULE_28__["debounce"])(fetchResults, 200);
  ...
  [].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_24___default()(epInputs), _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_24___default()(epBlockInputs)).forEach(function (input) {
