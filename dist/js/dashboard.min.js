...
var $epCredentialsAdditionalFields = (0, _jquery2.default)(document.getElementsByClassName('ep-additional-fields-row'));
var epHostField = document.getElementById('ep_host');
var epHost = epHostField.value;
var epHostNewValue = '';
...
function sync() {
	_jquery2.default.ajax({
		...
		if (0 === response.data.found_items && !response.data.start) {
			...
			if (!_window.epDash.intro_shown) {
				document.location.replace(_window.epDash.ep_intro_url);
			}
		} else {
