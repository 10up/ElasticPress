...
* Prevent the Comments REST search from disclosing approved comments on password-protected posts to unauthenticated visitors. Props [@mrglwglwgl](https://github.com/mrglwglwgl) and [@felipeelia](https://github.com/felipeelia).
* Bumped `postcss-selector-parser` from 7.1.0 to 7.1.5. Props [@dependabot](https://github.com/dependabot).
* Bumped `fast-uri` from 3.1.5 to 3.1.7. Props [@dependabot](https://github.com/dependabot).

__Developer:__

* Update `@wordpress/env` from 11.13.0 to 11.15.0. Props [@felipeelia](https://github.com/felipeelia).
